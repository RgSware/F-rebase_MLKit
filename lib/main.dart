import 'package:mm/ml_detail.dart';
...
class _MLHomeState extends State<MLHome> {
  ...
  Widget build(BuildContext context) {
    ...
    columns.add(buildRowTitle(context, 'Recognition Type'));
    columns.add(buildSelectScannerRowWidget(context));
    columns.add(buildtext(context));
  ...
  Widget buildtext(BuildContext context) {
    ...
    rows.add(buildRowTitle(context, 'Take a Picture'));
    rows.add(buildRowTitle(context, ' '));
    rows.add(buildRowTitle(context, 'Pick Image'));
    return Row(
      children: rows,
    );
  }
